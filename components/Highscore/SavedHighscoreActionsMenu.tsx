...
const SavedHighscoreActionsMenu: React.FC<HighscoreActionsMenuProps> = ({
    open,
    onClose,
    onShow,
    onSave,
    ...
    return createPortal(
        ...
        >
            ...
            <button className={`flex items-center px-4 py-2 w-full hover:bg-gray-50`} onClick={onSave}>💾 Unsave</button>
...
export default SavedHighscoreActionsMenu;
