        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(0,0,0,0.4)]">
            <div className="bg-white rounded-lg shadow-lg w-[30%] p-6 relative">
                <div className="border-b border-gray-200 mb-10">
                    ...
                    <h2 className="text-lg font-semibold mb-7">Edit HighScore Name</h2>
                </div>
                ...
                <div className="flex justify-end gap-2 mt-8">
                    ...
                    <button className="px-4 py-1 bg-[#00A3FF] text-white rounded" onClick={() => onSave(name)}>Edit Name</button>
                </div>
            </div>
        </div>
    );
